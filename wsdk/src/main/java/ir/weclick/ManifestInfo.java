...
class ManifestInfo {
  ...
  private static Context getContext() {
    return Weclick.getApplicationContext();
  }
  ...
  private static String getGcmManifestMessage() {
    ...
    return "make sure that these permissions are declared as children " +
        ...
        "\n" +
        "<service android:name=\"ir.weclick.PushService\" />\n" +
        "<receiver android:name=\"ir.weclick.GcmBroadcastReceiver\" " +
        ...
        "  </intent-filter>\n" +
        "</receiver>\n" +
        "<receiver android:name=\"ir.weclick.ParsePushBroadcastReceiver\"" +
        " android:exported=false>\n" +
        "  <intent-filter>\n" +
        "    <action android:name=\"ir.weclick.push.intent.RECEIVE\" />\n" +
        "    <action android:name=\"ir.weclick.push.intent.OPEN\" />\n" +
        "    <action android:name=\"ir.weclick.push.intent.DELETE\" />\n" +
        "  </intent-filter>\n" +
        "</receiver>";
  }
  ...
  private static String getPpnsManifestMessage() {
    return "make sure that these permissions are declared as children of the root " +
        ...
        "\n" +
        "<service android:name=\"ir.weclick.PushService\" />\n" +
        "<receiver android:name=\"ir.weclick.ParseBroadcastReceiver\">\n" +
        "  <intent-filter>\n" +
        ...
        " android:exported=false>\n" +
        "  <intent-filter>\n" +
        "    <action android:name=\"ir.parse.push.intent.RECEIVE\" />\n" +
        "    <action android:name=\"ir.weclick.push.intent.OPEN\" />\n" +
        "    <action android:name=\"ir.weclick.push.intent.DELETE\" />\n" +
        "  </intent-filter>\n" +
        "</receiver>";
